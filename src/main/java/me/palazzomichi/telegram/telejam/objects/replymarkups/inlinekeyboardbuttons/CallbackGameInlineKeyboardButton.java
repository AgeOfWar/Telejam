...
import me.palazzomichi.telegram.telejam.objects.CallbackGame;
...
public class CallbackGameInlineKeyboardButton extends InlineKeyboardButton {
  ...
  /**
   * Setter for property {@link #callbackGame}.
   *
   * @param callbackGame value for property {@link #callbackGame}
   */
